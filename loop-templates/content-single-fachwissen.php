		...
		<div class="entry-meta fachwissen-single-header-info-wrapper">
			<div class="fachwissen-single-header-meta-infobox">
				<div class="fachwissen-single-header-meta-info">
					...
					<div class="fachwissen-tag-single-page"><a href="<?php echo $fachwissen_file; ?>" title="<?php esc_attr_e( 'Download Article', 'tracomme2023-child' ); ?>"><?php esc_attr_e( 'Download Article', 'tracomme2023-child' ); ?></a>
					</div>
				</div>
			</div>
		</div><!-- .entry-meta -->
